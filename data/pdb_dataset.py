...
import random
import sys
sys.path.append("/dssg/home/acct-clschf/clschf/zxli/RNADiff-zxli/")
...
def get_config(config_override=None, debug=False) -> ml_collections.ConfigDict:
    ...
    cfg = ml_collections.ConfigDict({
        'pdb_csv_path': '/dssg/home/acct-clschf/clschf/zxli/RNADiff-zxli/data-RNAsolo-all500/processed_pdb/metadata.csv',
        'pdb_self_consistency_path': '/dssg/home/acct-clschf/clschf/zxli/RNADiff-zxli/data-RNAsolo-all500/processed_pdb/metadata.csv',
...
class PdbDataset(Dataset):
    ...
    def _process_csv_row(self, csv_row):
        ...
        processed_file_path = csv_row['pkl_path']
        ...
        if self.crop_len:
            if self.cropping_mode == 'contiguous_sequence':
                seq_len = chain_feats['bb_positions'].shape[0]
    ...
    def __getitem__(self, idx):
        ...
        restype = np.array([restype_3tonum[res] for res in chain_feats['restype']])
        chain_feats['restype'] = restype
