...
import dataclasses
import os,sys
sys.path.append("/dssg/home/acct-clschf/clschf/zxli/RNADiff/")
import numpy as np
import tree
import collections
import os
...
def parse_chain_feats(chain_feats, scale_factor=1., mean_center=True):
   ...
   # chain_feats['atom_positions'] = scaled_pos * chain_feats['atom_mask'][..., None]
    chain_feats['bb_positions'] = chain_feats['bb_positions']#[:, ca_idx]
...
def read_pkl(read_path: str, verbose=False):
    ...
    with open(read_path, 'rb') as handle:
        try:
            ...
            return pickle.load(handle)#,map_location='cpu')
